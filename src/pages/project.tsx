        ...
        <div className="project-page">
          ...
          <div className="cloud-animation">
            <div className="clouds">
              ...
              />
              <StaticImage
                src="../images/project/clouds/cloud2.png"
                alt="cloud"
            ...
            <Container>
              ...
              <Row>
                <Col>
                  <h2>Spaerow</h2>
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur itaque magnam sunt hic
                    tenetur, cum animi expedita consectetur nam, consequatur aspernatur! Natus impedit dolore quam
                    reiciendis ipsa dolorum quas perferendis.
                  </p>
                </Col>
                <Col>
                  <StaticImage
