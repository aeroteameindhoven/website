    ...
    <div>
      <Helmet>
        <link
          ...
          sizes="180x180"
          href="/apple-touch-icon.png?v=awoinurniahdw"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"
          href="/favicon-32x32.png?v=awoinurniahdw"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href="/favicon-16x16.png?v=awoinurniahdw"
        />
        <link rel="manifest" href="/site.webmanifest?v=awoinurniahdw" />
        <link
          rel="mask-icon"
          href="/safari-pinned-tab.svg?v=awoinurniahdw"
          color="#002878"
        />
